...
import { ChevronRight, Mail, Shield, Zap, BarChart2, RefreshCw, Check, Server, Clock, Lock, Code, Database } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex space-x-4">
                <button className="bg-white text-purple-600 px-6 py-3 rounded-lg font-medium flex items-center hover:bg-opacity-90 transition-all">
                  Commencer <ChevronRight className="ml-2 h-5 w-5" />
                </button>
                <button className="border border-white px-6 py-3 rounded-lg font-medium hover:bg-white hover:bg-opacity-10 transition-all">
                  Documentation
                </button>
              </div>
            </div>
  ...
  "limits": {
    ...
    "bounce_threshold": 2.5
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Un tableau de bord complet pour gérer tous les aspects de vos campagnes</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
            <div className="bg-gray-800 p-4 flex items-center space-x-2">
              ...
              <div className="h-3 w-3 rounded-full bg-yellow-400"></div>
              <div className="h-3 w-3 rounded-full bg-green-400"></div>
              <div className="flex-1 text-center text-gray-400 text-sm">North Eyes - Tableau de bord</div>
            </div>
            <div className="p-4 grid grid-cols-12 gap-4">
              <div className="col-span-2 bg-gray-50 p-4 rounded-lg">
                <div className="space-y-3">
                  <div className="bg-purple-100 text-purple-700 p-2 rounded-lg text-sm font-medium">Tableau de bord</div>
                  <div className="p-2 text-sm">Campagnes</div>
                  <div className="p-2 text-sm">Templates</div>
                  <div className="p-2 text-sm">Configuration SMTP</div>
                  <div className="p-2 text-sm">Expéditeurs</div>
                  <div className="p-2 text-sm">Statistiques</div>
                  <div className="p-2 text-sm">Paramètres</div>
                </div>
              </div>
              <div className="col-span-10 space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="grid grid-cols-4 gap-4">
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <div className="text-xs text-green-500">↑ 12% vs hier</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      <div className="text-sm text-gray-500">Taux de délivrabilité</div>
                      <div className="text-2xl font-bold">97.8%</div>
                      <div className="text-xs text-green-500">↑ 0.5% vs moyenne</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      <div className="text-sm text-gray-500">Taux de bounce</div>
                      <div className="text-2xl font-bold">1.2%</div>
                      <div className="text-xs text-green-500">↓ 0.3% vs moyenne</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      <div className="text-sm text-gray-500">SMTP actifs</div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium">Performance des campagnes actives</h3>
                    <div className="text-sm text-purple-600">Voir tout</div>
                  </div>
                  <div className="w-full h-40 bg-gray-50 rounded-lg relative overflow-hidden">
                    <div className="absolute bottom-0 left-0 w-full h-full flex items-end">
                      <div className="w-1/6 h-20 bg-purple-500 opacity-80 mx-1"></div>
                      <div className="w-1/6 h-32 bg-purple-500 opacity-80 mx-1"></div>
                      <div className="w-1/6 h-24 bg-purple-500 opacity-80 mx-1"></div>
                      <div className="w-1/6 h-28 bg-purple-500 opacity-80 mx-1"></div>
                      <div className="w-1/6 h-36 bg-purple-500 opacity-80 mx-1"></div>
                      <div className="w-1/6 h-16 bg-purple-500 opacity-80 mx-1"></div>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="font-medium">Rotation SMTP</h3>
                      <div className="text-sm text-purple-600">Configurer</div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-sm">250/hr</div>
                      </div>
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          <div className="w-2 h-2 rounded-full bg-green-500 mr-2"></div>
                        ...
                        <div className="text-sm">180/hr</div>
                      </div>
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                        ...
                        <div className="text-sm">120/hr</div>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="font-medium">Rotation Templates</h3>
                      <div className="text-sm text-purple-600">Modifier</div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <div>Template A</div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Forfaits adaptés à vos besoins</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Des options flexibles pour tous les volumes d'envoi</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:border-purple-200 transition-all">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold mb-2">Starter</h3>
                <div className="text-4xl font-bold mb-1">0.005 XMR</div>
                <div className="text-gray-500">par mille emails</div>
              </div>
              <div className="border-t border-b border-gray-200 py-6 mb-6">
                <ul className="space-y-3">
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>3 SMTP en rotation</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>5 expéditeurs différents</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>2 templates HTML</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-purple-500 transform scale-105 z-10 relative">
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold mb-1">0.025 XMR</div>
                <div className="text-gray-500">par mille emails</div>
              </div>
              <div className="border-t border-b border-gray-200 py-6 mb-6">
                <ul className="space-y-3">
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>10 SMTP en rotation</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>20 expéditeurs différents</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>10 templates HTML</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>Variables dynamiques avancées</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>Protection anti-bounce</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:border-purple-200 transition-all">
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold mb-1">0.075 XMR</div>
                <div className="text-gray-500">par mille emails</div>
              </div>
              <div className="border-t border-b border-gray-200 py-6 mb-6">
                <ul className="space-y-3">
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>SMTP illimités</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>Expéditeurs illimités</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                  ...
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
                    <span>Protection anti-bounce premium</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <Check className="h-5 w-5 text-green-500" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Tout ce que vous devez savoir sur North Eyes</p>
          </div>
          
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-semibold mb-2">Comment fonctionne la rotation des SMTP ?</h3>
              <p className="text-gray-600">Notre système alterne automatiquement entre vos différents fournisseurs SMTP selon les règles que vous définissez. Vous pouvez attribuer des poids différents à chaque fournisseur, définir des limites personnalisées et des conditions de rotation.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-semibold mb-2">Quels services SMTP sont compatibles ?</h3>
              <p className="text-gray-600">North Eyes est compatible avec tous les principaux fournisseurs SMTP : AWS SES, Sendgrid, Mailjet, Mailgun, Office365, Gmail, ainsi que n'importe quel serveur SMTP personnalisé.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-semibold mb-2">Comment fonctionne la protection contre les bounces ?</h3>
              <p className="text-gray-600">Notre système surveille en temps réel le taux de bounce de vos envois. Si ce taux dépasse le seuil que vous avez défini, le système arrête automatiquement la campagne pour protéger votre réputation d'expéditeur.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-semibold mb-2">Quelles mesures de confidentialité sont mises en place ?</h3>
              <p className="text-gray-600">Nous ne conservons aucune donnée permettant d'identifier nos utilisateurs : pas d'adresses IP, pas d'historique de connexion, et nous acceptons uniquement les paiements en crypto-monnaies pour garantir votre anonymat complet.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-500 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-medium hover:bg-opacity-90 transition-all">
              Créer un compte
            </button>
            <button className="border border-white px-8 py-3 rounded-lg font-medium hover:bg-white hover:bg-opacity-10 transition-all">
